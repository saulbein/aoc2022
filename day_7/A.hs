...
main = do
    ...
    print (contents & parseContent & foldl applyCommand initialTS & fileSystem & getAnswer)
...
getAnswer :: FileTree -> Int
getAnswer tree = tree & folders & map calcSize & filter (<100000) & sum
